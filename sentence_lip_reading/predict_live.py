...
PATH_TO_SHAPE_PREDICTOR = 'D:\Codebase\lip_reading_project_public\sentence_lip_reading\shape_predictor_68_face_landmarks.dat'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        video =   torch.FloatTensor(frame_accumulator.video).cpu()
